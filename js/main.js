...
function updateFooter() {
    ...
    if (copyright) {
        ...
        github.href = 'https://github.com/toolgram-dev/toolgram.tech';
...
function fixPageTopPadding() {
    ...
    style.textContent = `
        .page {
            padding-top: 207px !important;   /* adjust to your actual nav height */
        }
    `;
    document.head.appendChild(style);
}
